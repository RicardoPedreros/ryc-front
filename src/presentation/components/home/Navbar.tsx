    ...
    <header className="navbar">
      <nav className="navbar-inner">
        ...
        <div className="navbar-links">
          ...
          >
            <svg className="icon-dunkin" width="18" height="18" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
            ...
            <svg className="icon-default" width="18" height="18" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
